...
%TODO daleko vice popsat, co vsechno jde ladit...
...
%TODO prozkoumat visual vm plugin startup profiler
\subsection{JConsole}
...
% Musis zmenit options z javy 7 na javu 8 a napsat neco ve smyslu "Insted of Java 7 options we will use java 8 ..."
...
\begin{itemize}
	...
	\item \textit{fileWithResults} -- a text file will be stored in \texttt{\seqsplit{src/TunedConfiguration}} folder with found configurations. If you more times run a command with same \textit{fileWithResults} data will not be overwritten while new records will be added. A result entry syntax is shown in figure \ref{jatt-result}
\end{itemize}
