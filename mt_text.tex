...
%popsat pojmy: stop the world pauzu, mark, sweep, compact a vyndat to ze serialu, 
...
% navrzen aby odstranil dlouhe pauzy pri major GC
% udelat intro, ze minor jsou kratke a major dlouhe pauzy -- Minor garbage collections do not typically cause long pauses. However, full garbage collections or compacting garbage collections, even though infrequent, can impose long pauses, especially when large Java heaps are involved.
% minor GC bezi v podstate jako parallel colector => kratke stop the world pauzy
% na pozadi bezi jedno nebo vice vlaken, v periodach scanuje old.g. a ktere odstranuje mrtve objekty z old generation bez zadneho compact. Tim padem dochazi u old. g. k fragmentaci. Pokud v teto casti haldy nejde alokovat nove objekty, provede se stop-the-world a pomoci serial collectoru se provede GC nad old.g. (jedno vlakno) a pote se pokracuje conccurent, background again dokud zase neni old.g. prilis fragmenovana
